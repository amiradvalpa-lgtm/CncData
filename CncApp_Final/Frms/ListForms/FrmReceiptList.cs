...
{
    public partial class FrmReceiptList :
#if DEBUG
                    BaseFormList
#else
...
#endif
    {
        public FrmReceiptList() : base(new EfListService<Receipt>(() => new AppDbContext()))
        {
            InitializeComponent();
